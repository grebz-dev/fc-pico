...
::/ @file
::/ @brief Builds the FC PICO developer reference into docs_jp/html.
::/
...
if exist docs_jp\doxygen-warnings.log del /q docs_jp\doxygen-warnings.log
...
set WARNCOUNT=0
if exist docs_jp\doxygen-warnings.log (
    for /f %%A in ('find /c /v "" ^< docs_jp\doxygen-warnings.log') do set WARNCOUNT=%%A
)
...
echo ------------------------------------------------------------
type docs_jp\doxygen-warnings.log
echo ------------------------------------------------------------
exit /b 1
