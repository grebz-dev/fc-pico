...
To be completed in task [P0-T13](plan/10-workplan.md#p0-t13-licensing-and-attribution). Known at planning time:
...
| `fcppu.pio` | `tutorial_project/tuto1_hw/sys/pio/fcppu.pio` | BSD-3-Clause header (Raspberry Pi (Trading) Ltd.) with impact soft modifications; impact soft terms for the modifications are unclear (2025 (c) impact soft) | question H1 in [`plan/11-risks.md`](plan/11-risks.md) |
